...
current_dataset3 = 'Nursery'
current_number_of_features3 = 8
current_good_features3 = list(range(1, 9, 1))
...
def plot_average_over_number_of_features_encoded(dataset_type=1, evaluation_metric='accuracy'):
    ...
    current_good_features1 = []
    current_good_features2 = []
    current_good_features4 = []
    ...
    sns.lineplot(x=0, y=[baseline_performance * 100],
    ...
    sns.lineplot(x=0, y=[baseline_performance2 * 100],
    ...
    sns.lineplot(x=0, y=[baseline_performance4 * 100],
    ...
    #plt.tight_layout()
    plt.savefig(f'./results_performance_avg_database/average_datasets_effectiveness2.pdf', dpi=1200,
                bbox_inches='tight')
    # plt.show()
    plt.clf()