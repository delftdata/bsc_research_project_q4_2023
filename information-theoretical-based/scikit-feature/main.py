...
if __name__ == '__main__':
    ...
    datasets.append({'name': 'Breast cancer', 'path': '../../datasets/breast-cancer/breast_cancer.csv', 'y_label': 'diagnosis', 'n_features': 30, 'is_classification': True})
    ...
    datasets.append({'name': 'Gisette', 'path': '../../datasets/gisette/gisette.csv', 'y_label': 'Class', 'n_features': 250, 'is_classification': True})
